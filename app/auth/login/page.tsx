  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row items-center md:items-start sm:justify-center md:justify-start flex-auto min-w-0 h-screen">
        ...
        <div className="relative hidden md:flex flex-auto items-center justify-center w-1/4 h-full p-16 lg:px-28 overflow-hidden bg-[url('/images/log-in-bg.png')] dark:border-l"></div>
      </div>
    </div>
  );
}
